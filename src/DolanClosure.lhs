...
This module contains almost exactly the code from the above paper by Stephen Dolan.
To simplify tests, we used our type class for Kleene algebras instead of the type class for semirings
presented in the paper.

We refer to the excellent documentation in the paper for details about the functions.
